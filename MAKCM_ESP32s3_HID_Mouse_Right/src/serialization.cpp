...
void EspUsbHost::sendDeviceInfo()
{
    ...
    String output = "USB_sendDeviceInfo:" + json + "\n";
...
void EspUsbHost::sendDescriptorDevice()
{
    ...
    String json;
    serializeJson(doc, json);
    String output = "USB_sendDescriptorDevice:" + json + "\n";
    serialWriteMessage(output);
}
...
void EspUsbHost::sendEndpointDescriptors()
{
    ...
    String json;
    serializeJson(doc, json);
    String output = "USB_sendEndpointDescriptors:" + json + "\n";
    serialWriteMessage(output);
}
...
void EspUsbHost::sendInterfaceDescriptors()
{
    ...
    String json;
    serializeJson(doc, json);
    String output = "USB_sendInterfaceDescriptors:" + json + "\n";
    serialWriteMessage(output);
}
...
void EspUsbHost::sendHidDescriptors()
{
    ...
    String json;
    serializeJson(doc, json);
    String output = "USB_sendHidDescriptors:" + json + "\n";
    serialWriteMessage(output);
}
...
void EspUsbHost::sendIADescriptors()
{
    ...
    String json;
    serializeJson(doc, json);
    String output = "USB_sendIADescriptors:" + json + "\n";
    serialWriteMessage(output);
}
...
void EspUsbHost::sendEndpointData()
{
    ...
    String json;
    serializeJson(doc, json);
    String output = "USB_sendEndpointData:" + json + "\n";
    serialWriteMessage(output);
}
...
void EspUsbHost::sendUnknownDescriptors()
{
    ...
    String json;
    serializeJson(doc, json);
    String output = "USB_sendUnknownDescriptors:" + json + "\n";
    serialWriteMessage(output);
}
...
void EspUsbHost::sendDescriptorconfig()
{
    ...
    String json;
    serializeJson(doc, json);
    String output = "USB_sendDescriptorconfig:" + json + "\n";
    serialWriteMessage(output);
}
